...
<head>
    ...
    <title>CP Office Registration</title>   
    <style>
 body {
 ...
 <img src="logo1.png" alt="" class="logo-form2">
    <div class="class1" id="container">
        <div class="login-form" id="login-form">
            ...
            <h1>Commissioner of Police Office Login</h1>
            ...
            <form id="login" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                <div class="form-group">
                    ...
                    <select name="officer_name" id="officer_name" required>
                        ...
                        $sql = "SELECT officer_name FROM cp";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT password FROM cp WHERE officer_name='$officer_name'";
    $result = $conn->query($sql);
    ...
    if ($result->num_rows > 0) {
        ...
        if ($password === $db_password) {
            ...
            echo "<script>window.location.href = 'cp_map.php';</script>";
        } else {
